# simple-rank
This is a mysql formula for wilson ranking algorithm for articles/posts that is based on upvote, downvote, and number of views. This would be useful for those of you that want to create things like best rated posts.
